        ...
        <div class="login_box">
            ...
            <div id="first">
                <form action="register.php" method="POST" id="login-form">
                    ...
                    <input type="submit" name="login_button" id="button" value="Sign in">
                    <br>
                    <a href="#" id="signup" class="signup">Don't have an account? Create Your Account</a>
